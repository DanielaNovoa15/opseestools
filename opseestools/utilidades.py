...
def fiber_elemens_Columns(BCol, HCol, c, cT, cM, cB, nT, nM, nB, fc, Fy, yloc):
    '''
    Function to generate columns with fiber elements with 2 different steel 
    configurations.
    ...
    fcu = 0.2 * fc
    Gfc = fc / 1000
    e20 = e20Lobatto(Gfc, Lcol, pint, fc/1000, E/1000, ec)
    ...
    fucc = 0.2 * fcc
    Gfcc = 2 * (fcc / 1000)
    e20cc = e20Lobatto(Gfcc, Lcol, pint, fcc/1000, E/1000, ecc)
...
def fiber_elemens_Beams(BCol, HCol, c, cT, cB, nT, nB, fc, Fy, xloc):
    '''
    Function to generate beams with fiber elements with 2 different steel 
    configurations.
    ...
    fcu = 0.2 * fc
    Gfc = fc / 1000
    e20 = e20Lobatto(Gfc, Lvig, pint, fc/1000, E/1000, ec)
    ...
    fucc = 0.2 * fcc
    Gfcc = 2 * (fcc / 1000)
    e20cc = e20Lobatto(Gfcc, Lvig, pint, fcc/1000, E/1000, ecc)
